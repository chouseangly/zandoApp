                ...
                {loading ? (
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="flex-shrink-0 text-center">
                            <img src={profileImage} alt="Profile" className="w-32 h-32 rounded-full mx-auto object-cover border-4 border-gray-200" />
                            <h3 className="text-xl font-bold mt-4">{customer.firstName} {customer.lastName}</h3>
                            <p className="text-gray-500">{customer.userName}</p>
                            <span className="mt-2 inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">{customer.role}</span>
                        </div>
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-gray-700">{profile?.phoneNumber || 'Not provided'}</span>
                            </div>
                             <div className="flex items-center gap-4">
                                <User size={18} className="text-gray-400" />
                                <span className="text-gray-700 capitalize">{profile?.gender || 'Not provided'}</span>
                            </div>
                            <div className="flex items-center gap-4">
                             ...
                             <div className="flex items-start gap-4">
                                ...
                                <span className="text-gray-700">{profile?.address || 'Not provided'}</span>
                            </div>
                            <div className="text-sm text-gray-400 pt-4 border-t mt-4">
